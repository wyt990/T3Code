...
export const ClaudeSettings = Schema.Struct({
  enabled: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
  binaryPath: makeBinaryPathSetting("claudecode"),
  customModels: Schema.Array(Schema.String).pipe(Schema.withDecodingDefault(Effect.succeed([]))),
...
export const ProxySettings = Schema.Struct({
  enabled: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
  httpProxy: TrimmedString.pipe(Schema.withDecodingDefault(Effect.succeed(""))),
  httpsProxy: TrimmedString.pipe(Schema.withDecodingDefault(Effect.succeed(""))),
});
...
export const ServerSettings = Schema.Struct({
  ...
  proxy: ProxySettings.pipe(Schema.withDecodingDefault(Effect.succeed({}))),
});
...
const ProxySettingsPatch = Schema.Struct({
  enabled: Schema.optionalKey(Schema.Boolean),
  httpProxy: Schema.optionalKey(Schema.String),
  httpsProxy: Schema.optionalKey(Schema.String),
});
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  proxy: Schema.optionalKey(ProxySettingsPatch),
});
