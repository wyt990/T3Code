...
export function createLocalApi(rpcClient: WsRpcClient): LocalApi {
  return {
    ...
    server: {
      ...
      refreshClaudeAgentModels: rpcClient.server.refreshClaudeAgentModels,
      upsertKeybinding: rpcClient.server.upsertKeybinding,
      getSettings: rpcClient.server.getSettings,
      updateSettings: rpcClient.server.updateSettings,
    },
    provider: {
      getInstallMethods: rpcClient.provider.getInstallMethods,
      install: rpcClient.provider.install,
    },
    claudeCode: {
      install: rpcClient.claudeCode.install,
    },
    openCode: {
      install: rpcClient.openCode.install,
    },
  };
}
