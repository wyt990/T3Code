    ...
    <SettingsPageContainer>
      {canManageLocalBackend ? (
                  ...
                  desktopServerExposureState?.endpointUrl
                    ...
                    : desktopServerExposureState?.mode === "network-accessible"
                      ? desktopServerExposureState.advertisedHost
                        ? `暴露在所有接口上。配对链接使用 ${desktopServerExposureState.advertisedHost}。`
                        : "暴露在所有接口上。"
        ...
        <SettingsSection title="Local backend access">
          <SettingsRow
            title="所有者工具"
            description="配对链接和客户端会话管理仅适用于此后端的所有者会话。"
          />
        </SettingsSection>
      )}
          ...
          >
            ...
            <DialogPopup>
              <DialogHeader>
                ...
                <DialogDescription>配对另一个环境到此客户端。</DialogDescription>
              ...
              <DialogPanel>
                <div className="space-y-4">
                  {savedBackendMode === "pairing-url" ? (
                    ...
                    <p className="text-xs text-muted-foreground">输入后端主机和配对代码分别。</p>
                  )}
      ...
      >
        ...
        {savedEnvironmentIds.length === 0 ? (
          <div className={ITEM_ROW_CLASSNAME}>
            <p className="text-xs text-muted-foreground">
              暂无远程环境。点击 &ldquo;添加环境&rdquo; 以配对另一个远程环境。
            </p>
          </div>
        ) : null}
      </SettingsSection>
